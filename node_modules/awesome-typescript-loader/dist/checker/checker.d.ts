...
export declare class Checker {
    ...
    webpackOptions?: any;
    sender: QueuedSender;
    constructor(compilerInfo: CompilerInfo, loaderConfig: LoaderConfig, compilerConfig: TsConfig, webpackOptions: any);
    req<T>(message: Req): Promise<T>;
    emitFile(fileName: string, text: string): Promise<EmitFile.ResPayload>;
    updateFile(fileName: string, text: string): Promise<{}>;
